...
// LightClientFinalityUpdate provides the light client finality_update of a given block ID.
...
// LightClientOptimisticUpdate provides the light client optimistic_update of a given block ID.
